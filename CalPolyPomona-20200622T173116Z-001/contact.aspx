            ...
            <div class="maps-form">
                ...
                <div class="col-md-6 form">
                    <div class="heading">
                        ...
                        <form runat="server" id="ct_frm">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="form-group">
                                    <!-- <input class="form-control" id="name" name="name" placeholder="Name" type="text" required> -->
                                    <asp:textbox runat="server" class="form-control" id="name" placeholder="Name*" required="true"></asp:textbox>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="form-group">
                                    <asp:textbox runat="server" class="form-control" id="email" name="email" placeholder="Email*" type="email" required></asp:textbox>
                                    <span class="alert-error"></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="row">
                                <div class="form-group">
                                    <asp:textbox runat="server" class="form-control" id="phone" name="phone" placeholder="Phone*" type="text" required></asp:textbox>
                                    <span class="alert-error"></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="row">
                                <div class="form-group comments">
                                    ...
                                    <asp:textbox runat="server" id="comments" class="form-control" textmode="multiline" height="150px" placeholder="Tell Me About Courses *" required></asp:textbox>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <asp:button id="btn_SendMessage" runat="server" onclick="btn_SendMessage_Click" text="Send message" CssClass="btn btn-block"></asp:button>
                            </div>
                        </div>
                            </form>
                        <!-- Alert Message -->
                        <div class="col-md-12 alert-notification">
                            <div id="message" runat="server" class="alert-msg"></div>
                        </div>
