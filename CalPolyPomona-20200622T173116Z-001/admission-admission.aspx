            ...
            <div class="about-items">
                <div class="col-md-8">
                    ...
                    <ul class="list about-list">
                        <li><i class="fas fa-angle-right" style="padding-bottom: 5px;"></i> Demonstrated mastery of college algebra, statistics, and object-oriented programming with a grade of “C” or better in relevant coursework.</li>
                        <li><i class="fas fa-angle-right" style="padding-bottom: 5px;"></i> Undergraduate degree with at least 2.5 Grade Point Average (or equivalent).</li>
                        <li><i class="fas fa-angle-right" style="padding-bottom: 5px;"></i> For International students: demonstrated proof of English proficiency, e.g., TOEFL score of 550 (paper-based), 213 (computer-based) or 79 (internet-based), or IELTS of 6.5 or above.</li>
                        <li><i class="fas fa-angle-right" style="padding-bottom: 5px;"></i> Two letters of recommendation letters</li>
                        <li><i class="fas fa-angle-right" style="padding-bottom: 5px;"></i> Past working experience and background in business analytics or closely related areas</li>
                    </ul>
                    <div style="padding-top: 20px;"></div>
                    <h2>Application</h2>
                    <p class="j-data" style="padding-bottom: 5px;">Application procedures include a two-part process. Prospective applicants must complete an application through CSU Apply and submit official transcripts from all universities and colleges attended. Applicants must also submit a statement of purpose that identifies their discipline focus and two letters of recommendation from individuals able to assess the applicant’s potential for success in master’s level academic performance.</p>
                    <p class="j-data" style="padding-bottom: 5px;">Applicants with an undergraduate degree in other disciplines, and those who do not fully satisfy other department or university graduate admission requirements may be considered for possible conditional admission. These conditions may include additional coursework, minimum scholarship, compensating strengths, or other requirements. Candidates with conditional status are provided a written statement of entrance conditions, including the time within which the conditions are to be met.</p>
                    <p class="j-data" style="padding-bottom: 5px;">Students in conditional standing must satisfactorily complete 12 units with a GPA of 3.0 or higher before becoming eligible for unconditional graduate standing. If the conditions are not satisfied, the candidate will be denied further enrollment in the program.</p>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-8">
                    ...
                    <ul class="list about-list">
                        <li><i class="fas fa-angle-right" style="padding-bottom: 5px;"></i> TOEFL (If required) 213 Computer Based/550 Paper Based/80 Internet Based, or</li>
                        <li><i class="fas fa-angle-right" style="padding-bottom: 5px;"></i> IELTS 6.5, or</li>
                        <li><i class="fas fa-angle-right" style="padding-bottom: 5px;"></i> CPELI Level 6 (Cal Poly Pomona English Language Institute)</li>
                    </ul>
                </div>
                <div class="col-md-4">                    
                </div>
                ...
                <div class="col-md-8">
                    <h2 style="padding-top: 25px;">Tuition and Fees</h2>
