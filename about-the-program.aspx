...
<!--                    </div>-->
                ...
                <div class="col-md-12">
                    ...
                    <ul class="list about-list">
                        ...
                        <li style="font-size: 18px;"><i class="fas fa-angle-right"></i> Project experiences throughout the program</li>
                        <li style="font-size: 18px;"><i class="fas fa-angle-right"></i> Learn powerful toolboxes (R, Python, Tableau, Hadoop etc.)</li>
                        <li style="font-size: 18px;"><i class="fas fa-angle-right"></i> Focus on business story telling competences</li>
                        <li style="font-size: 18px;"><i class="fas fa-angle-right"></i> Convenient locations at Cal Poly Pomona</li>
                    </ul>
                </div>
            </div>
        </div>
