<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="admission-admission.aspx.vb" Inherits="CalPolyPomona.admission_admission" %>
    ...
    <div class="container">
        <div class="row">
            <div class="about-items">
                <div class="col-md-12">
                    <h4>Admission</h4>
                    <p>The M.S. Business Analytics is open to students who hold a baccalaureate degree with certain quantitative and programming background from a regionally accredited college or university.</p>
                    <p>The admission to this program is based on the holistic view of the following criterion:</p>
